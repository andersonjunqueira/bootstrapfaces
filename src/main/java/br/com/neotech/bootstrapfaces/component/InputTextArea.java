...
public class InputTextArea extends HtmlInputTextarea implements IFormControl{
    ...
    @Override
    public int getRows() {
        return (Integer)getStateHelper().eval(BSPropertyKeys.rows, BFConstantes.DEFAULT_INPUTAREA_ROWS_SIZE);
    }
    ...
    public String getDir() {
        return (String)getStateHelper().eval(HtmlInputTextarea.PropertyKeys.dir, BFConstantes.DEFAULT_DIR);
    }
